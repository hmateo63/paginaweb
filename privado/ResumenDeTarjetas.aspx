<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ResumenDeTarjetas.aspx.vb"
    Inherits="privado_ResumenDeTarjetas" %>
...
<%--    <ul class="nav navbar-nav navbar-right">
    ...
    <form id="form1" runat="server">
                            ...
                            <a href="DashBoard.aspx" class="btn btn-danger"><i class="icon-home">
                    </i></a>
            ...
            <div id="DivArea1" runat="server">
                ...
                <div class='formrow'>
                    <label for="tel2" class="col-md-1 control-label">
                        Destino</label>
                    <div class="col-md-3">
                        <asp:DropDownList ID="DropDestino" runat="server" class="form-control input-sm">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class='formrow'>
    ...
    <div runat="server" id="DivGridView2">
        ...
        <!--CLIENTE-->
        <div class="formRow" id="div2">
            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="TRUE" CssClass="table table-bordered dataTable dataTable-scroll-x">
            </asp:GridView>
        </div>
    </div>
    <%--            ***************************--%>
